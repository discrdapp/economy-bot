...
class Util(commands.Cog):
	...
	async def work(self, ctx):
		...
		# def is_me(res):
		# 	if res.user.id == author.id:
		# 		return res
		# but1 = Button(label="yeet", style=1, id="1")

		# await ctx.send("yeet", components=[[but1]])
		# try:
		# 	res = await self.bot.wait_for("button_click", check = is_me, timeout = 45)
		# except:
		# 	raise Exception("timeoutError")
